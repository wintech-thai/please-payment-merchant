  ...
  return (
    <>
      <nav
        ...
        style={{ background: 'linear-gradient(135deg, #c2510c 0%, #92400e 40%, #d97706 100%)' }}
      >
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-white text-sm tracking-wide leading-none">PLEASE-PAYMENT</p>
              <p className="text-orange-200 text-xs leading-none mt-0.5">Admin</p>
            </div>
          </div>
